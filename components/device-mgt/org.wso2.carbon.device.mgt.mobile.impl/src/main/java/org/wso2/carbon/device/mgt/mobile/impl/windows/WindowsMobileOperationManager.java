...
public class WindowsMobileOperationManager extends AbstractMobileOperationManager {

    private static final Log log = LogFactory.getLog(WindowsMobileOperationManager.class);
    ...
    public boolean addOperation(Operation operation, List<DeviceIdentifier> devices)
        ...
        try {
            ...
            String msg = String.format("Error while adding operation %s to Windows device", operation.getCode());
            log.error(msg, e);
    ...
    public List<Operation> getPendingOperations(DeviceIdentifier deviceIdentifier) throws OperationManagementException {
        ...
        try {
            ...
            String msg = "Error occurred when retrieving pending operations in Windows device " + deviceIdentifier.getId();
            log.error(msg, e);
            throw new OperationManagementException(msg, e);
        }
        return operations;
    ...
    @Override
    public List<Feature> getFeaturesForDeviceType(String s) throws FeatureManagementException {
        return null;
    }
}
